...
<video autoplay muted loop id="background-video">
  <source src="../images/teal.mp4" type="video/mp4">
    ...
    <div class="pr-main">
        <div class="pr-main-top">
            <div class="pr-top-1">
                ...
                <h1 class="lime3">Mango Loco Protein Powder</h1>
                ...
                <div class="perksnew">
                        <div class="perknew3"><img height="30px" src="../images/omu.svg" alt="" srcset="">svalstvo</div>
                        <div class="perknew3"><img height="30px" src="../images/osc.svg" alt="" srcset="">soustředění</div>
                        <div class="perknew3"><img height="30px" src="../images/oen.svg" alt="" srcset="">energie</div>
                        <div class="perknew3"><img height="30px" src="../images/ole.svg" alt="" srcset="">přírodní</div>
                        <div class="perknew3"><img height="30px" src="../images/monLOGO.svg" alt="" srcset=""><p>Monster</p></div>
                </div>        
            </div>
            <div class="pr-top-2">
                <img  height="80%" src="../images/lmonbox.png" alt="" srcset="">
            </div>
            <div class="pr-top-3">
        ...
        <div class="pr-main-bottom">
             <button class="add-to-cart buy3" data-name="Monster Energy Mango Loco tablets" data-price="800" data-image="../images/lmonbox.png">Koupit</button>
