...
<div class="pr-all">
    <div class="pr-main">
        <div class="pr-main-top">
            <div class="pr-top-1">
                <h2>For health</h2>
                <h1 class="mainName2">N.K.R.T.D. POWDER</h1>
                <h1 class="lime5">PROTEIN/KRATOM/METH</h1>
            ...
            <div class="pr-top-2">
                <img  height="60%" src="../images/terbg.png" alt="" srcset="">
            </div>
            <div class="pr-top-3">
        ...
        <div class="pr-main-bottom">
            <button class="add-to-cart buy4" data-name="N.K.R.T.D. powder" data-price="1488" data-image="../images/terbg.png">Koupit</button>
