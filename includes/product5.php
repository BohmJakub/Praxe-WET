...
<div class="pr-all">
    <div class="pr-main">
        <div class="pr-main-top">
            ...
            <div class="pr-top-2">
                <img  height="80%" src="../images/lmonbag.png" alt="" srcset="">
            </div>
            <div class="pr-top-3">
        ...
        <div class="pr-main-bottom">
            <button class="add-to-cart buy3" data-name="Monster Energy Mango Loco powder" data-price="800" data-image="../images/lmonbag.png">Koupit</button>
