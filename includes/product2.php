...
<div class="pr-all">
    <div class="pr-main">
        <div class="pr-main-top">
            ...
            <div class="pr-top-2">
                <img  height="80%" src="../images/monbotl.png" alt="" srcset="">
            </div>
            <div class="pr-top-3">
        ...
        <div class="pr-main-bottom">
             <button class="add-to-cart buy" data-name="Monster Energy Tablets" data-price="800" data-image="../images/monbotl.png">Koupit</button>
