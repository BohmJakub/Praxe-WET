...
<div class="pr-all">
    <div class="pr-main">
        <div class="pr-main-top">
            ...
            <div class="pr-top-2">
                <img  height="80%" src="../images/wmonbotl.png" alt="" srcset="">
            </div>
            <div class="pr-top-3">
        ...
        <div class="pr-main-bottom2">
             <button class="add-to-cart buy2" data-name="Monster Energy Ultra Tablets" data-price="800" data-image="../images/wmonbotl.png">Koupit</button>
