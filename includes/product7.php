...
<div class="pr-all">
    <div class="pr-main">
        <div class="pr-main-top">
            <div class="pr-top-1">
                <h2>For health</h2>
                <h1 class="mainName2">MEGA BONK</h1>
                <h1 class="lime4">Protein Powder</h1>
                ...
                <div class="perksnew">
                        ...
                        <div class="perknew"><img height="30px" src="../images/cz.svg" alt="" srcset="">České</div>
                </div>        
            </div>
            <div class="pr-top-2">
                <img  height="100%" src="../images/prdbg.png" alt="" srcset="">
            </div>
            <div class="pr-top-3">
        ...
        <div class="pr-main-bottom">
                        <button class="add-to-cart buy" data-name="MEGA BONK powder" data-price="600" data-image="../images/prdbg.png">Koupit</button>
